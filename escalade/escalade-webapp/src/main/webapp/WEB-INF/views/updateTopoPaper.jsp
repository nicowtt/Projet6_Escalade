...
<div class="container">
    ...
    <!-- display for see topoPapier to update-->
    <br>
    <div id="listerTopoPapier">
        <table class="table">
            ...
            <c:forEach items="${topoPaperToUpdate}" var="to">
                <tr>
                    <td>${to.nomTopo}</td>
    ...
    <!-- form for update topoPaper -->
    <div id="NewTopoPapier">
        <h3>Modification du topo papier:</h3>

        <p></p>
        <c:forEach items="${topoPaperToUpdate}" var="to">
        <f:form modelAttribute="topopapier" method="post" action="${pageContext.request.contextPath}/updatePaperTopo/${to.id}">
